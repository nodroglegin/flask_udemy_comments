...
class Blog(db.Model):
    ...
    #following allows SQLAlchemy to do dynamic lookups between tables
    #ie Blog model can lookup the posts in the Post model for a given blog
...
class Comment(db.Model):
    ...
    # self.body is the body column is the body 3 lines above
    # the body on the RHS is being passed from the function inputs
    # =None is a default value if not entered
